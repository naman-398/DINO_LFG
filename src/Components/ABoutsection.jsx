    ...
    return (
        <div id='about' className=' bg-[#09655A] md:pt-[35px] 576:pt-[15px] 992:pt-[76px] pb-[17px] relative '>
            ...
            <div className=' max-w-[1140px] mx-auto px-3 relative z-[2]'>
                ...
                <p className=' font-balsamiq text-[20px] 576:text-[24px] text-center text-[#FFF] mt-[8px] 576:mt-[18px] font-normal leading-[normal] 576:leading-[28.8px] max-w-[560px] mx-auto'   data-aos="zoom-in">Biggest problem of meme coins is lack of utility and usecase,  
